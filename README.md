...
In every main module more specific submodules can be found. Every submodule contains the interactive notebooks which are used as a main resource for content delivery.
