...
### Understand the separation of concerns in communication systems

Participants understand the layered approach of the ISO-OSI model and:

* Are familiar with the basic concepts of digital communication networks
* Identify important components digital communication networks
* Know the difference between point-to-point and end-to-end communication


### Distinguish and characterise common wireless communication protocols

Participants will develop an understanding the following technologies and select the appropriate technologies for a given application:
* Wi-Fi
* Bluetooth
* Zigbee
* Z-wave
...
### Distinguish and characterise common wired communication protocols
...
Participants are not expected to have any prior knowledge in network and communication technologies. Reasonable Python skills are needed for the exercises.
